...
func TestBackup(t *testing.T) {
	...
	fmt.Printf("i am called __(a)__")
	leader1 := cfg.checkOneLeader()
	cfg.disconnect((leader1 + 2) % servers)
	cfg.disconnect((leader1 + 3) % servers)
	cfg.disconnect((leader1 + 4) % servers)

	fmt.Printf("i am called __(b)__")
	...
	fmt.Printf("i am called __(c)__")
	cfg.disconnect((leader1 + 0) % servers)
	cfg.disconnect((leader1 + 1) % servers)

	fmt.Printf("i am called __(d)__")
	// allow other partition to recover
	cfg.connect((leader1 + 2) % servers)
	cfg.connect((leader1 + 3) % servers)
	cfg.connect((leader1 + 4) % servers)

	fmt.Printf("i am called __(e)__")
	// lots of successful commands to new group.
	for i := 0; i < 50; i++ {
		cfg.one(rand.Int(), 3)
	}

	fmt.Printf("i am called __(f)__")
	...
	fmt.Printf("i am called __(g)__")
	...
	fmt.Printf("i am called __(h)__")
	...
	fmt.Printf("i am called __(i)__")
	// lots of successful commands to new group.
	for i := 0; i < 50; i++ {
		cfg.one(rand.Int(), 3)
	}

	fmt.Printf("i am called __(j)__")
	// now everyone
	for i := 0; i < servers; i++ {
		cfg.connect(i)
	}
